...
ROUTED_SUBCOMMANDS="add apply clean diff doctor edit export history import init list open remove rm status validate"
...
@test "all routed subcommands appear in the man page" {
  for c in add apply clean diff doctor edit export history import init list open remove status validate; do
