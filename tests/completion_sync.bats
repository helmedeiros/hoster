...
ROUTED_SUBCOMMANDS="add apply clean diff edit export import init list remove rm status"
...
@test "all routed subcommands appear in the man page" {
  for c in add apply clean diff edit export import init list remove status; do
